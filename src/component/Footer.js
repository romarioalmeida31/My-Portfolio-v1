    ...
    <React.StrictMode>
      <div className="copyright-details">
        <div className="about-social-icon text-center">
          <ul className="about-social">
            ...
            <li className="wow fadeIn" data-wow-delay=".6s">
              <a
                href="https://www.linkedin.com/in/romario-almeida"
                target="newtab"
              >
            ...
            <li className="wow fadeIn" data-wow-delay=".4s">
              <a
                href="https://www.instagram.com/eusouromarioo"
                target="newtab"
              >
            ...
            <li className="wow fadeIn" data-wow-delay="1.2s">
              <a href="https://github.com/romarioalmeida31/romarioalmeida31" target="newtab">
        ...
        <div className="copyright">
          <h3>&copy; {currYear},  by Romário Almeida.</h3>
        </div>
        <a
